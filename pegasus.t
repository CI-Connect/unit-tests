...
--------
  ...
  $ cd ~/data/workflows/jenkins/pegasus
  $ rm -rf wordfreq-workflow > ${TESTDIR}/rm_wf.txt 2>&1

  $ ls wordfreq-workflow
  ls: cannot access wordfreq-workflow: No such file or directory
  [2]