...
-----------
  ...
  $ sed 's;+ProjectName;#+ProjectName;' check_gromacs.new3 > check_gromacs.submit
  $ echo >> check_gromacs.submit
  $ sed -i "12s/$/Requirements = (IS_GLIDEIN == True) \&\& (HAS_CVMFS_oasis_opensciencegrid_org =?= TRUE)/" check_gromacs.submit
  $ echo >> check_gromacs.submit
